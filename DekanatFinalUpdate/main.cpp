...
int main() {
    ...
    Subject prog("Programming");

    vector<Subject>group2;
    group2.push_back(prog);
    group2.push_back(math);
    ...
    // Creating group
    Group group("PMI", group1);
    vector<Group> groups;
    Group groupp("PMA", group2);
    ...
    marks1.emplace(prog, temp);
    // Creating students
    Student student1("John", "pass1", "PMI", marks1);
    Student student2("Jane", "pass2", "PMI", marks1);
    Student student3("Mike", "pass3", "PMI", marks1);
    Student student4("Marik", "pass4", "PMA", marks1);
    Student student5("Nazar", "pass5", "PMA", marks1);
    Student student6("Max", "pass6", "PMA", marks1);
    ...
    groupp.addStudent(student4);
    groupp.addStudent(student5);
    groupp.addStudent(student6);

    groups.push_back(group);
    // Creating a teacher
    Teacher teacher1("Smith", "teacherpass", math);
//    vector<Teacher> teachers = { teacher1, teacherr };
    Teacher teacherr("Olga", "olgapass", prog);
    vector<Teacher> teachers = { teacher1, teacherr };
    ...
    Student student7("Sarah", "pass4", "PMI", marks1);
